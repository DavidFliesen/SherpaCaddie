const CACHE="sherpa-caddie-v0.11.1";
const APP_FILES=[
  "./",
  "./index.html?v=0111",
  "./manifest.webmanifest?v=0111",
  "./assets/sherpa-caddie-logo-fast.webp?v=0111",
  "./assets/sage-sherpa-live.webp?v=0111",
  "./icons/icon-192.png?v=0111",
  "./icons/icon-512.png?v=0111",
  "./icons/favicon.png?v=0111"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0111"))
    );
    return;
  }
