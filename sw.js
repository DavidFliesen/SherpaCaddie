const CACHE="sherpa-caddie-v0.11.5";
const APP_FILES=[
  "./",
  "./index.html?v=0115",
  "./manifest.webmanifest?v=0115",
  "./assets/sherpa-caddie-logo-fast.webp?v=0115",
  "./assets/sage-sherpa-live.webp?v=0115",
  "./icons/icon-192.png?v=0115",
  "./icons/icon-512.png?v=0115",
  "./icons/favicon.png?v=0115"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0115"))
    );
    return;
  }
