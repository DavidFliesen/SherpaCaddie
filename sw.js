const CACHE="sherpa-caddie-v0.11.7";
const APP_FILES=[
  "./",
  "./index.html?v=0117",
  "./manifest.webmanifest?v=0117",
  "./arteziq-ui.css?v=0117",
  "./arteziq-audio.js?v=0117",
  "./arteziq-ui.js?v=0117",
  "./assets/sherpa-caddie-logo-fast.webp?v=0117",
  "./assets/sage-sherpa-live.webp?v=0117",
  "./icons/icon-192.png?v=0117",
  "./icons/icon-512.png?v=0117",
  "./icons/favicon.png?v=0117"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0117"))
    );
    return;
  }
