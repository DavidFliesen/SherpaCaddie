const CACHE="sherpa-caddie-v0.11.14";
const APP_FILES=[
  "./",
  "./index.html?v=0124",
  "./manifest.webmanifest?v=0124",
  "./arteziq-ui.css?v=0124",
  "./arteziq-audio.js?v=0124",
  "./arteziq-ui.js?v=0124",
  "./assets/sherpa-caddie-logo-fast.webp?v=0124",
  "./assets/sage-sherpa-live.webp?v=0124",
  "./icons/icon-192.png?v=0124",
  "./icons/icon-512.png?v=0124",
  "./icons/favicon.png?v=0124"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0124"))
    );
    return;
  }
