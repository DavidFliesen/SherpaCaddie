const CACHE="sherpa-caddie-v0.11.13";
const APP_FILES=[
  "./",
  "./index.html?v=0123",
  "./manifest.webmanifest?v=0123",
  "./arteziq-ui.css?v=0123",
  "./arteziq-audio.js?v=0123",
  "./arteziq-ui.js?v=0123",
  "./assets/sherpa-caddie-logo-fast.webp?v=0123",
  "./assets/sage-sherpa-live.webp?v=0123",
  "./icons/icon-192.png?v=0123",
  "./icons/icon-512.png?v=0123",
  "./icons/favicon.png?v=0123"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0123"))
    );
    return;
  }
