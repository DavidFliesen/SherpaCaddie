const CACHE="sherpa-caddie-v0.11.6";
const APP_FILES=[
  "./",
  "./index.html?v=0116",
  "./manifest.webmanifest?v=0116",
  "./arteziq-ui.css?v=0116",
  "./arteziq-audio.js?v=0116",
  "./arteziq-ui.js?v=0116",
  "./assets/sherpa-caddie-logo-fast.webp?v=0116",
  "./assets/sage-sherpa-live.webp?v=0116",
  "./icons/icon-192.png?v=0116",
  "./icons/icon-512.png?v=0116",
  "./icons/favicon.png?v=0116"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0116"))
    );
    return;
  }
