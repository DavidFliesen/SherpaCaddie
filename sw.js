const CACHE="sherpa-caddie-v0.7.0";
const APP_FILES=[
  "./",
  "./index.html?v=070",
  "./manifest.webmanifest?v=070",
  "./assets/sherpa-caddie-logo-fast.webp?v=070",
  "./icons/icon-192.png?v=070",
  "./icons/icon-512.png?v=070",
  "./icons/favicon.png?v=070"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=070"))
    );
    return;
  }
