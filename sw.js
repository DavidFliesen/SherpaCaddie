const CACHE="sherpa-caddie-v0.11.12";
const APP_FILES=[
  "./",
  "./index.html?v=0122",
  "./manifest.webmanifest?v=0122",
  "./arteziq-ui.css?v=0122",
  "./arteziq-audio.js?v=0122",
  "./arteziq-ui.js?v=0122",
  "./assets/sherpa-caddie-logo-fast.webp?v=0122",
  "./assets/sage-sherpa-live.webp?v=0122",
  "./icons/icon-192.png?v=0122",
  "./icons/icon-512.png?v=0122",
  "./icons/favicon.png?v=0122"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0122"))
    );
    return;
  }
