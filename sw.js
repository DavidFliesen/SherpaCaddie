const CACHE="sherpa-caddie-v0.6.4";
const APP_FILES=[
  "./",
  "./index.html?v=064",
  "./manifest.webmanifest?v=064",
  "./assets/sherpa-caddie-logo-fast.webp?v=064",
  "./icons/icon-192.png?v=064",
  "./icons/icon-512.png?v=064",
  "./icons/favicon.png?v=064"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=064"))
    );
    return;
  }
