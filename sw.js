const CACHE="sherpa-caddie-v0.10.0";
const APP_FILES=[
  "./",
  "./index.html?v=0100",
  "./manifest.webmanifest?v=0100",
  "./assets/sherpa-caddie-logo-fast.webp?v=0100",
  "./icons/icon-192.png?v=0100",
  "./icons/icon-512.png?v=0100",
  "./icons/favicon.png?v=0100"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0100"))
    );
    return;
  }
