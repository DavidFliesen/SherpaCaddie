const CACHE="sherpa-caddie-v0.11.4";
const APP_FILES=[
  "./",
  "./index.html?v=0114",
  "./manifest.webmanifest?v=0114",
  "./assets/sherpa-caddie-logo-fast.webp?v=0114",
  "./assets/sage-sherpa-live.webp?v=0114",
  "./icons/icon-192.png?v=0114",
  "./icons/icon-512.png?v=0114",
  "./icons/favicon.png?v=0114"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0114"))
    );
    return;
  }
