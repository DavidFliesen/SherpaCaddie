const CACHE="sherpa-caddie-v0.6.3";
const APP_FILES=[
  "./",
  "./index.html?v=063",
  "./manifest.webmanifest?v=063",
  "./assets/sherpa-caddie-logo-fast.webp?v=063",
  "./icons/icon-192.png?v=063",
  "./icons/icon-512.png?v=063",
  "./icons/favicon.png?v=063"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=063"))
    );
    return;
  }
