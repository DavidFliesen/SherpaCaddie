const CACHE="sherpa-caddie-v0.11.11";
const APP_FILES=[
  "./",
  "./index.html?v=0121",
  "./manifest.webmanifest?v=0121",
  "./arteziq-ui.css?v=0121",
  "./arteziq-audio.js?v=0121",
  "./arteziq-ui.js?v=0121",
  "./assets/sherpa-caddie-logo-fast.webp?v=0121",
  "./assets/sage-sherpa-live.webp?v=0121",
  "./icons/icon-192.png?v=0121",
  "./icons/icon-512.png?v=0121",
  "./icons/favicon.png?v=0121"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0121"))
    );
    return;
  }
