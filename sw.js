const CACHE="sherpa-caddie-v0.11.8";
const APP_FILES=[
  "./",
  "./index.html?v=0118",
  "./manifest.webmanifest?v=0118",
  "./arteziq-ui.css?v=0118",
  "./arteziq-audio.js?v=0118",
  "./arteziq-ui.js?v=0118",
  "./assets/sherpa-caddie-logo-fast.webp?v=0118",
  "./assets/sage-sherpa-live.webp?v=0118",
  "./icons/icon-192.png?v=0118",
  "./icons/icon-512.png?v=0118",
  "./icons/favicon.png?v=0118"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0118"))
    );
    return;
  }
