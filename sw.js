const CACHE="sherpa-caddie-v0.11.3";
const APP_FILES=[
  "./",
  "./index.html?v=0113",
  "./manifest.webmanifest?v=0113",
  "./assets/sherpa-caddie-logo-fast.webp?v=0113",
  "./assets/sage-sherpa-live.webp?v=0113",
  "./icons/icon-192.png?v=0113",
  "./icons/icon-512.png?v=0113",
  "./icons/favicon.png?v=0113"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0113"))
    );
    return;
  }
