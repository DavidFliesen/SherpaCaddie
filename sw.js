const CACHE="sherpa-caddie-v0.11.10";
const APP_FILES=[
  "./",
  "./index.html?v=0120",
  "./manifest.webmanifest?v=0120",
  "./arteziq-ui.css?v=0120",
  "./arteziq-audio.js?v=0120",
  "./arteziq-ui.js?v=0120",
  "./assets/sherpa-caddie-logo-fast.webp?v=0120",
  "./assets/sage-sherpa-live.webp?v=0120",
  "./icons/icon-192.png?v=0120",
  "./icons/icon-512.png?v=0120",
  "./icons/favicon.png?v=0120"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=0120"))
    );
    return;
  }
