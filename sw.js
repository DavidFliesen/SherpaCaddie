const CACHE="sherpa-caddie-v0.6.0";
const APP_FILES=[
  "./",
  "./index.html?v=060",
  "./manifest.webmanifest?v=060",
  "./assets/sherpa-caddie-logo.png?v=060",
  "./assets/sherpa-caddie-logo-clean.png?v=060",
  "./icons/icon-192.png?v=060",
  "./icons/icon-512.png?v=060",
  "./icons/favicon.png?v=060"
];
...
self.addEventListener("fetch", event => {
  ...
  if(request.mode === "navigate"){
    event.respondWith(
      fetch(request).catch(() => caches.match("./index.html?v=060"))
    );
    return;
  }
